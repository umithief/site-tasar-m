    ...
    return (
        <div className="p-8 text-white min-h-screen">
            ...
            <div className="flex items-center justify-between mb-8 border-b border-white/10 pb-6">
                <div>
                    <h1 className="text-3xl font-black italic uppercase tracking-tighter">UI KONTROL MERKEZİ</h1>
                    <p className="text-gray-400">Arayüz ve Marka Yönetim Sistemi</p>
                </div>

                <div className="flex bg-[#111] p-1 rounded-xl border border-white/10">
                    <button
                        onClick={() => setActiveModule('branding')}
                        className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${activeModule === 'branding' ? 'bg-moto-accent text-black' : 'text-gray-400 hover:text-white'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${activeModule === 'buttons' ? 'bg-moto-accent text-black' : 'text-gray-400 hover:text-white'
                            }`}
                    >
            ...
            {activeModule === 'branding' ? (
                ...
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                    {/* BUTTON DESIGNER CONTENT (Existing) */}
                    ...
                    {/* LIVE PREVIEW SIDEBAR - Only for Buttons */}
                    <div className="w-full lg:w-96 sticky top-8">
                        <div className="bg-[#111] border border-white/10 rounded-3xl p-8 flex flex-col items-center gap-12 min-h-[500px] justify-center relative overflow-hidden">
                            ...
                            <div className="relative z-10 flex flex-col items-center gap-6 w-full">
                                ...
                                <VibeButton variant="primary" size="lg" configOverride={localConfig} fullWidth>Principal Action</VibeButton>
                                <div className="flex gap-4 w-full">
                                    <VibeButton variant="secondary" size="md" configOverride={localConfig} className="flex-1">Secondary</VibeButton>
                                    <VibeButton variant="ghost" size="md" configOverride={localConfig} className="flex-1">Ghost</VibeButton>
                                </div>
                                <VibeButton variant="outline" size="sm" configOverride={localConfig}>Minimal Outline</VibeButton>
                                <VibeButton variant="danger" size="sm" configOverride={localConfig} fullWidth>System Error</VibeButton>
                            </div>

                            {/* Save Action for Buttons */}
                            <div className="w-full pt-8 border-t border-white/10 mt-auto">
                                <VibeButton
                                    variant="primary"
                                    size="sm"
                                    onClick={handleSave}
