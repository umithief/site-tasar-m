            ...
            <AnimatePresence>
                {isHovered && (
                    <motion.div
                        ...
                        className="absolute left-full bg-gray-900/80 backdrop-blur-md border border-white/10 px-3 py-1.5 rounded-xl text-xs font-bold text-white shadow-xl whitespace-nowrap z-50 pointer-events-none"
                    >
                        {item.label}
