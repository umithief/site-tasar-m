...
import { Home, ShoppingBag, User, Compass, X, Zap, LogIn, Power, Wrench, MessageSquare, BookOpen, MapPin, ChevronRight, Activity, MessageSquarePlus, Menu, Settings, LogOut, Palette, Users } from 'lucide-react';
                            ...
                            <div className="flex-1 overflow-y-auto px-6 py-2 custom-scrollbar">
                                ...
                                <div className="grid grid-cols-2 gap-3 mb-6">
                                    {[
                                        ...
                                        { id: 'social-hub', label: 'HUB', icon: MessageSquare, color: 'text-pink-400 bg-pink-400/10' },
