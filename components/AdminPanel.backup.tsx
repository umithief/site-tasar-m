...
export const AdminPanel: React.FC<AdminPanelProps> = ({ onLogout, onShowToast, onNavigate }) => {
    ...
    console.log("AdminPanel RUNNING. Sidebar Open:", isSidebarOpen, "Data Loading...");
    ...
    return (
        <ErrorBoundary>
            <div className="h-screen bg-blue-900 border-4 border-red-500 text-white font-sans flex overflow-hidden selection:bg-[#F2A619] selection:text-black">
                {/* --- SIDEBAR --- */}
