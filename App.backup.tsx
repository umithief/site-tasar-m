...
export const App: React.FC = () => {
    ...
    const renderView = () => {
        switch (view) {
            ...
            case 'admin': return <div className="h-full w-full bg-red-500"><ErrorBoundary><AdminPanel onLogout={() => { authService.logout(); setUser(null); navigateTo('home'); }} onShowToast={addToast} onNavigate={navigateTo} /></ErrorBoundary></div>;
