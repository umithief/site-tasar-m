...
export const ResponsiveDashboardLayout: React.FC<ResponsiveDashboardLayoutProps> = ({
    ...
    return (
        <div className="w-full mx-auto grid grid-cols-1 lg:grid-cols-[280px_1fr_350px] gap-6 relative items-start max-w-[1800px] px-0 lg:px-6">
            ...
            {rightSidebar && (
                <div className="hidden lg:block sticky top-0 h-screen overflow-y-auto custom-scrollbar p-0 space-y-8 bg-transparent">
                    {rightSidebar}
                </div>
            )}
        </div>
